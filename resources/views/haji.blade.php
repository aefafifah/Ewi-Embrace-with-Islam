...
@section('content')
    ...
    <section class="dalil">
        ...
        <div class="dalil-container">
            <h3 class="dalil-title">~ Surah Al-Baqarah, Ayat 189</h3>
            <div class="dalil-box">
                <div class="dalil-content">
                    <p> يَسْـَٔلُونَكَ عَنِ ٱلْأَهِلَّةِ ۖ قُلْ هِىَ مَوَٰقِيتُ لِلنَّاسِ وَٱلْحَجِّ ۗ وَلَيْسَ ٱلْبِرُّ
            ...
            <h3 class="dalil-title">~ Surah Al-Baqarah, Ayat 197</h3>
            <div class="dalil-box">
                <div class="dalil-content">
                    <p>ٱلْحَجُّ أَشْهُرٌۭ مَّعْلُومَـٰتٌۭ ۚ فَمَن فَرَضَ فِيهِنَّ ٱلْحَجَّ فَلَا رَفَثَ وَلَا فُسُوقَ وَلَا
            ...
            <h3 class="dalil-title">~ Surah Ali 'Imran', Ayat 97</h3>
            <div class="dalil-box">
                <div class="dalil-content">
                    <p>فِيهِ ءايَـٰتٌۢ بَيِّنَـٰتٌۭ مَّقَامُ إِبْرَٰهِيمَ ۖ وَمَن دَخَلَهُۥ كَانَ ءامِنًۭا ۗ وَلِلَّهِ عَلَى
                ...
                <div class="button-container">
                    ...
                    <button class="tatbhiq-button" data-title="Tatbhiq Surah Ali 'Imran', Ayat 97"
                        ...
                        Kelima, orang yang memasukinya akan aman.">Tatbhiq</button>
                </div>
            </div>
